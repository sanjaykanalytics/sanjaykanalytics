...
**Rajadhani Institute of Hotel Management and Catering Technology, Trivandrum**
...
**Quest Innovative Solutions Pvt Ltd** | Oct 2025 – Present

* Undergoing internship-based training in Data Analytics and Generative AI.
* Working with Excel for data cleaning, analysis, and reporting.
* Learning and applying SQL, Python, Power BI, and Tableau.
* Building analytical skills through hands-on projects.

### Industrial Trainee

**Jaisalmer Marriott Resort & Spa** | Jan 2023 – May 2023

* Completed industrial training in hotel operations.
* Assisted in reporting, coordination, and daily operations.
...
* Certificate in Advanced Excel (Amity University)
* Understanding Business (LinkedIn Learning)

### Human Resources & Business

* Hiring and Onboarding Employees with ClickUp (Coursera)
* HR & Administration Course (Edwin Academy)
* Certificate Course in Leadership and Motivation in Organization (Amity University)
* Certificate in Principles of Retailing (Amity University)
* Certificate Course in Professional and Life Skills (Amity University)
* Certificate Course in Basic Mathematics (Amity University)

---

## 📂 Featured Projects

### 📌 The Great Resignation: Rethinking Talent in the Post-Pandemic Era

MBA Major Project focused on employee attrition and retention strategies in the post-pandemic era.
